...
export const SearchToolbar = ({
  ...
  return (
    <header className="h-36 bg-pattern-mobile lg:bg-pattern-desktop relative">
      <div className="bg-white flex gap-2 md:rounded-2xl p-4 absolute w-full max-w-4xl -translate-1/2 left-1/2 bottom-0 shadow-card translate-y-1/2">
